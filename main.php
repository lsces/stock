...
//Point of access for StockRemote requests
$gStockRemote = new StockRemote();
...
if( !empty( $_REQUEST['g2_form'] ) ){
	$gStockRemote->processRequest( !empty( $_GET['g2_form'] ) ? $_GET['g2_form'] : [], !empty( $_POST['g2_form'] ? $_POST['g2_form'] : []) );
