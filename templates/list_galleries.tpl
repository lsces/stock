<link rel="stylesheet" href="/photos/css/stock.css">
{strip}
			...
			<div class="row galleries">
				...
				<div class="col-xs-6 col-sm-4 col-md-3 ">
					<div class="{$gal.content_type_guid} thumbnail">
						...
						{if $gBitSystem->isFeatureActive('stock_list_user')}
							<strong>{displayname hash=$gal nolink=true}</strong> <small><a href="{$smarty.const.STOCK_PKG_URL}list_galleries.php?user_id={$gal.user_id}" style="display:block;">{tr}Galleries{/tr}</a></small>
						{/if}
