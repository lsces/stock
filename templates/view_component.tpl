	...
	{if empty($liberty_preview)}
		<div class="floaticon">
			...
			{if $gContent->hasUpdatePermission()}
				...
				<a title="{tr}Delete{/tr}" href="{$smarty.const.STOCK_PKG_URL}edit_component.php?content_id={$gContent->mContentId}&amp;delete=1">{biticon ipackage="icons" iname="edit-delete" iexplain="Delete Component"}</a>
			{/if}
		</div>
	{/if}
